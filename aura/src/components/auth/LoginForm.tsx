...
const LoginForm: FC<LoginFormProps> = ({ onSubmit }) => {
  const { email, setEmail, password, setPassword, errors, isLoading, handleSubmit } = useLoginForm(onSubmit);
    ...
    <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">
          ...
          <Link to="/auth/register" className="font-medium text-blue-600 hover:text-blue-500">Regístrate</Link>
        </p>
      </div>
